...
import com.example.testdatabaseimport.Bids;
...
public class Placebid_fragment extends Fragment {
    ...
    private TextInputLayout mTitle_layout, mCondition_layout, mDecription_layout, mModel_layout, mBidStartingPrice_layout, mNowPrice_layout, mError
            ,mMileage_layout,mtransmission_layout,mEndDate_layout;
    //for images
    ...
    private MaterialButton mCategory, mSubmit, mYear;
    //category
...
//        databaseReference = FirebaseDatabase.getInstance().getReference("Bidssss");
        databaseReference = FirebaseDatabase.getInstance().getReference().child("adsAdmin").child("cars");
        ...
        ////////////layouts//////////////
        {
            mMileage_layout = view.findViewById(R.id.Mileage_layout);
            mtransmission_layout = view.findViewById(R.id.transmission_layout);
            mEndDate_layout = view.findViewById(R.id.EndDate_layout);
        ...
        String tt = mSubmit.getText().toString();
        if (mCategory.getText().equals("Categories"))
        ...
        /////////////////////////////////////////////
        // to open the dialog with category options//
        /////////////////////////////////////////////
            ...
            public void onClick(View v) {
                ...
                builder.setItems(listitem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mCategory.setText(listitem[which]);
                        dialog.dismiss();
                    }
                });
        ...
        /////////////////////////////////////////
        // to open the dialog with year options//
        ////////////////////////////////////////
    ...
    private void addBid() {
        ...
        String Item_id,higestBider,Id, Title, Model,Year,Condition, Description,EndDate ,Price,ImageURL,Milage,Transmition ;
        //Todo Add hours to date
        Calendar calendar = Calendar.getInstance();
        String currentDate = DateFormat.getDateInstance().format(calendar.getTime());
        EndDate = currentDate;
        Id = currentuser;
        Item_id = databaseReference.push().getKey();
        ImageURL = "testing now";
        Milage = mMileage_layout.getEditText().getText().toString().trim();
        Transmition = mtransmission_layout.getEditText().getText().toString().trim();
        Title = mTitle_layout.getEditText().getText().toString().trim();
        Condition = mCondition_layout.getEditText().getText().toString().trim();
        Description = mDecription_layout.getEditText().getText().toString().trim();
...
//        bidStartingPrice = mBidStartingPrice_layout.getEditText().getText().toString().trim();
        Price = mNowPrice_layout.getEditText().getText().toString().trim();
        Year = mYear.getText().toString().trim();
        higestBider= currentuser;
        if (Year.equals("year")) {
...
////        }
            ...
            Bids bid = new Bids(higestBider,Id, Title, Model,Year,Condition, Description,EndDate ,Price,ImageURL,Milage,Transmition);
            databaseReference.child(Item_id).setValue(bid);
            Toasty.success(getActivity(), "Bid Added waiting approve", Toast.LENGTH_LONG, true).show();
